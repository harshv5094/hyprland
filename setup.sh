...
function packageInstall() {
  if cmdExist paru; then
    ...
    paru -S --noconfirm hyprland kitty nautilus hyprpaper hyprpicker hypridle hyprlock hyprwall-bin rofi nwg-look brightnessctl pavucontrol xdg-desktop-portal-hyprland wl-clipboard copyq swaync mate-polkit blueman waybar papirus-icon-theme otf-font-awesome ttf-jetbrains-mono-nerd playerctl network-manager-applet grimblast-git
  else
